export default defineBackground(() => {
  ...
  async function fetchLLMResponse(selectedText: string, apiKey: string, locale: string, replaceText: boolean) {
    const systemContent = replaceText
      ? "You are a helpful assistant that reformats text for simplicity and extracts complex keywords with explanations."
      : "You are a helpful assistant that extracts complex keywords with explanations.";
